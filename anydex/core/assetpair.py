...
class AssetPair:
    ...
    @staticmethod
    def from_price(price: Price, first_amount: int) -> AssetPair:
        return AssetPair(AssetAmount(first_amount, price.denom_type),
                         AssetAmount(int(price.frac * first_amount), price.num_type))
